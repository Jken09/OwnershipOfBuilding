 ...
 * @author USER
 */
public class viewBuilding extends javax.swing.JFrame {
   ...
   String url = "jdbc:derby://localhost:1527/C:/derby/Ownership";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewBuilding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewBuilding().setVisible(true);
            }
        });
    }
